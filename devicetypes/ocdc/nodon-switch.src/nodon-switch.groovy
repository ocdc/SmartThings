 ...
 *
 * ===== NodOn Octan Remote and NodOn Wall Switch =====
 * 	
 *	Modified for NodOn Octan Remote (CRC-3-1-0x) by Richard_Woodward
 *  Also Works for NodOn Wall Switch (CWS-3-1-01)
 *
 *	Supports 4 actions per button	Pushed
 *									Double Tap
 *									Held
 *									Hold Released
 *
...
metadata {
	...
	tiles {
		standardTile("button", "device.button", width: 2, height: 2) {
			state "default", label: "", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#ffffff"
			state "button 1 pushed", label: "pushed #1", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#79b821"
			state "button 2 pushed", label: "pushed #2", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#79b821"
			state "button 3 pushed", label: "pushed #3", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#79b821"
			state "button 4 pushed", label: "pushed #4", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#79b821"
			state "button 1 held", label: "held #1", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#ffa81e"
			state "button 2 held", label: "held #2", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#ffa81e"
			state "button 3 held", label: "held #3", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#ffa81e"
			state "button 4 held", label: "held #4", icon: "https://raw.githubusercontent.com/wosl/SmartThings/master/DeviceTypes/NodonSwitch/icon.png", backgroundColor: "#ffa81e"
		}
