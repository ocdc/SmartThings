 ...
 *  Mod Date: 2017-05-09
 *
 *  Version: 1.11 (Mod 0.1)
 *
 *  Source: https://github.com/codersaur/SmartThings/tree/master/smartapps/influxdb-logger
 *  Mod Source: https://github.com/wosl/SmartThings/tree/master/SmartApps/InfluxDbLogger
 *
...
definition(
    ...
    iconX2Url: "https://github.com/wosl/SmartThings/raw/master/SmartApps/InfluxDbLogger/icon@2x.png",
    iconX3Url: "https://github.com/wosl/SmartThings/raw/master/SmartApps/InfluxDbLogger/icon@3x.png")
...
preferences {
    ...
    section ("InfluxDB Database:") {
        ...
        input (
        	name: "prefDatabaseInternalExternal",
        	title: "Where does InfluxDB instance reside:\nInternal is on the local network, external is outside the local network.",
        	type: "enum",
        	options: [
        	    "0" : "Internal",
        	    "1" : "External"
...
def updated() {
    ...
    state.databaseInternalExternal = (settings.prefDatabaseInternalExternal) ? settings.prefDatabaseInternalExternal.toInteger() : 0
...
def postToInfluxDB(data) {
    ...
    if(state.databaseInternalExternal == 0) {
        try {
    ...
    if(state.databaseInternalExternal == 1) {
...
private getGroupName(id) {
    ...
    else if (id == 'GUID') {return 'Room Name'}
    else {return 'Unknown'}    
}
